...
namespace SignalR.WPF.Client
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public string ConnectionId
        {
            ...
            {
                connectionId = value;
                CreateQR($@"http://193.112.56.169:83?id={connectionId}"  );
            }
        }
        ...
        private void CreateQR(string info)
        {
            QRCodeGenerator qrGenerator = new QRCodeGenerator();
            QRCodeData qrCodeData = qrGenerator.CreateQrCode(info, QRCodeGenerator.ECCLevel.Q);
            QRCode qrCode = new QRCode(qrCodeData);
            Bitmap qrCodeImage = qrCode.GetGraphic(5, System.Drawing.Color.Black, System.Drawing.Color.White, null, 15, 6, true);
            ...
            Dispatcher.Invoke(() => QrImg.Source = wpfBitmap);
        }
